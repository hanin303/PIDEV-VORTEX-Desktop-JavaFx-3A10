...
public class SendEmail {
    ...
    public String VerificationMail(String sendTo){
        String host="swiftTransitOriginal2@hotmail.com";  
        final String user="swiftTransitOriginal2@hotmail.com";
        final String password="AbirMachraoui";
